...
int main() {
    ...
    cout << "=====================================" << endl;
    cout << "   Round Robin CPU Scheduling Simulator" << endl;
    cout << "   (Quantum = 2)" << endl;
    cout << "=====================================" << endl << endl;
    ...
    while (terminated_count < (int)processes.size()) {
        ...
        if (!has_running && !ready_queue.isEmpty()) {
            ...
            running_process.time_in_running = 0;
            has_running = true;
        ...
        if (has_running) {
            ...
            running_process.time_in_running++;
            ...
            if (running_process.remaining_time <= 0) {
                ...
                terminated_count++;
                has_running = false;
            } else if (running_process.time_in_running >= time_quantum) {
                // Quantum expired: preempt and put back in ready queue
